...
const ALL_ENTRIES = [
  ...
  // DAILY PHRASES
  {c:"Chiholloli",p:"chih-HOH-loh-lee",e:"I love you",cat:"Daily Phrases",ctx:"The most intimate expression of love in Chikashshanompa' — used between family members and loved ones.",q:"How do you say 'I love you' in Chickasaw?",a:"Chiholloli (chih-HOH-loh-lee) means 'I love you' in Chikashshanompa'. It is one of the most meaningful phrases in the language, used between family members and loved ones."},
  {c:"Sanokhanglo",p:"sah-noh-HAHNG-loh",e:"I am sorry",cat:"Daily Phrases",ctx:"The Chickasaw expression of apology and remorse.",q:"How do you say 'I am sorry' in Chickasaw?",a:"Sanokhanglo (sah-noh-HAHNG-loh) means 'I am sorry' in Chikashshanompa'. It expresses genuine remorse and is an important phrase in maintaining respectful relationships."},
  {c:"Ki'yo",p:"KIH-yoh",e:"No",cat:"Daily Phrases",ctx:"The Chickasaw word for no — used to decline or disagree.",q:"How do you say 'no' in Chickasaw?",a:"Ki'yo (KIH-yoh) means no in Chikashshanompa'. The glottal stop at the end is an important feature of Chickasaw pronunciation."},
  {c:"Kamassa' ishholiitobla'shki",p:"kah-MAH-sah ish-hoh-LEE-toh-blah-shkih",e:"Respect your elders",cat:"Daily Phrases",ctx:"A foundational value statement — respect for elders is central to Chickasaw culture and social order.",q:"How do you say 'respect your elders' in Chickasaw?",a:"Kamassa' ishholiitobla'shki means 'respect your elders' in Chikashshanompa'. Respect for elders is one of the most foundational values in Chickasaw culture — elders are the knowledge keepers of language, tradition, and history."},
  {c:"Minti cha impa",p:"MIN-tee chah IM-pah",e:"Come and eat",cat:"Daily Phrases",ctx:"A common household phrase — an invitation to share a meal, central to Chickasaw hospitality.",q:"How do you say 'come and eat' in Chickasaw?",a:"Minti cha impa (MIN-tee chah IM-pah) means 'come and eat' in Chikashshanompa'. Sharing food is central to Chickasaw hospitality and community life."},
  {c:"Nokchito",p:"nohk-CHIH-toh",e:"Behave!",cat:"Daily Phrases",ctx:"A command used with children — to behave properly and with respect.",q:"How do you say 'behave' in Chickasaw?",a:"Nokchito (nohk-CHIH-toh) means 'behave!' in Chikashshanompa'. It is commonly used with children as a reminder to act with respect and proper conduct."},
  {c:"Nosit aya",p:"NOH-sit AH-yah",e:"Go to bed",cat:"Daily Phrases",ctx:"A household phrase used at bedtime.",q:"How do you say 'go to bed' in Chickasaw?",a:"Nosit aya (NOH-sit AH-yah) means 'go to bed' in Chikashshanompa'."},

  // COMMANDS
  {c:"Chokkilissa",p:"chohk-kih-LIS-sah",e:"Be quiet",cat:"Commands",ctx:"A command for silence — used in formal and informal settings.",q:"How do you say 'be quiet' in Chickasaw?",a:"Chokkilissa (chohk-kih-LIS-sah) means 'be quiet' in Chikashshanompa'."},
  {c:"Binnili",p:"bin-NIH-lee",e:"Sit down",cat:"Commands",ctx:"A basic command used in daily life and ceremonial settings.",q:"How do you say 'sit down' in Chickasaw?",a:"Binnili (bin-NIH-lee) means 'sit down' in Chikashshanompa'."},
  {c:"Hika",p:"HIH-kah",e:"Get up / Stand up",cat:"Commands",ctx:"Used to tell someone to rise or get up.",q:"How do you say 'get up' or 'stand up' in Chickasaw?",a:"Hika (HIH-kah) means 'get up' or 'stand up' in Chikashshanompa'."},
  {c:"Iliya",p:"ih-LEE-yah",e:"Let's go",cat:"Commands",ctx:"An inclusive command — let us go together.",q:"How do you say 'let's go' in Chickasaw?",a:"Iliya (ih-LEE-yah) means 'let's go' in Chikashshanompa'. It is an inclusive phrase inviting everyone to go together."},
  {c:"Pisa",p:"PIH-sah",e:"Look",cat:"Commands",ctx:"A command to direct attention.",q:"How do you say 'look' in Chickasaw?",a:"Pisa (PIH-sah) means 'look' in Chikashshanompa'."},
  {c:"Aachi",p:"AH-chee",e:"Say it",cat:"Commands",ctx:"A command to speak or say something.",q:"How do you say 'say it' in Chickasaw?",a:"Aachi (AH-chee) means 'say it' in Chikashshanompa'."},
  {c:"Chokkowa",p:"chohk-KOH-wah",e:"Come in",cat:"Commands",ctx:"An invitation to enter — used at the door of a home.",q:"How do you say 'come in' in Chickasaw?",a:"Chokkowa (chohk-KOH-wah) means 'come in' in Chikashshanompa'. It is used to welcome someone into a home or space."},
  {c:"Ilihilha",p:"ih-lih-HIL-hah",e:"Let's dance",cat:"Commands",ctx:"An invitation to dance together — particularly relevant to stomp dance traditions.",q:"How do you say 'let's dance' in Chickasaw?",a:"Ilihilha (ih-lih-HIL-hah) means 'let's dance' in Chikashshanompa'. Dancing is central to Chickasaw ceremonial and community life."},
  {c:"Kapochcha ilito'li",p:"kah-POHCH-chah ih-lih-TOH-lee",e:"Let's play stickball",cat:"Commands",ctx:"Stickball (ishtaboli) is the sacred traditional Chickasaw game — sometimes called 'the little brother of war'.",q:"How do you say 'let's play stickball' in Chickasaw?",a:"Kapochcha ilito'li (kah-POHCH-chah ih-lih-TOH-lee) means 'let's play stickball' in Chikashshanompa'. Stickball is the sacred traditional Chickasaw game, deeply tied to cultural identity and spiritual practice."},
  {c:"Alhlhi anoli",p:"AHL-hee ah-NOH-lee",e:"Tell the truth",cat:"Commands",ctx:"A command rooted in the core Chickasaw value of truth and honesty.",q:"How do you say 'tell the truth' in Chickasaw?",a:"Alhlhi anoli (AHL-hee ah-NOH-lee) means 'tell the truth' in Chikashshanompa'. Truth is a foundational value in Chickasaw culture and governance."},
  {c:"Nanna anoli amanoli",p:"NAH-nah ah-NOH-lee ah-MAH-noh-lee",e:"Tell me a story",cat:"Commands",ctx:"Stories are the primary way Chickasaw cultural knowledge and values are transmitted across generations.",q:"How do you say 'tell me a story' in Chickasaw?",a:"Nanna anoli amanoli (NAH-nah ah-NOH-lee ah-MAH-noh-lee) means 'tell me a story' in Chikashshanompa'. Oral storytelling is the primary way Chickasaw cultural knowledge, history, and values are transmitted across generations."},

  // FOOD PHRASES
  {c:"Chipobataa?",p:"chih-poh-BAH-tah",e:"Are you hungry?",cat:"Food Phrases",ctx:"A common question expressing care and hospitality.",q:"How do you ask 'are you hungry?' in Chickasaw?",a:"Chipobataa? (chih-poh-BAH-tah) means 'are you hungry?' in Chikashshanompa'. Offering food to guests is central to Chickasaw hospitality."},
  {c:"Sapoba",p:"sah-POH-bah",e:"I am hungry",cat:"Food Phrases",ctx:"The phrase for expressing hunger.",q:"How do you say 'I am hungry' in Chickasaw?",a:"Sapoba (sah-POH-bah) means 'I am hungry' in Chikashshanompa'."},
  {c:"Impa chibanna?",p:"IM-pah chih-BAN-nah",e:"Do you want to eat?",cat:"Food Phrases",ctx:"An invitation to eat — a phrase of hospitality.",q:"How do you ask 'do you want to eat?' in Chickasaw?",a:"Impa chibanna? (IM-pah chih-BAN-nah) means 'do you want to eat?' in Chikashshanompa'. Offering food is a central expression of Chickasaw hospitality and care."},
  {c:"Impa chokma",p:"IM-pah CHOHK-mah",e:"The food is great!",cat:"Food Phrases",ctx:"An expression of appreciation for food — a compliment to the cook.",q:"How do you say 'the food is great' in Chickasaw?",a:"Impa chokma (IM-pah CHOHK-mah) means 'the food is great!' in Chikashshanompa'. It is a warm compliment to express after a good meal."},
  {c:"Bala",p:"BAH-lah",e:"Beans",cat:"Food",ctx:"Beans were a staple crop alongside corn and squash in the traditional Chickasaw Three Sisters agricultural system.",q:"What is the Chickasaw word for beans?",a:"Bala (BAH-lah) means beans in Chikashshanompa'. Beans were part of the Three Sisters — corn, beans, and squash — the foundational crops of traditional Chickasaw agriculture."},
  {c:"Nipi",p:"NIH-pee",e:"Meat",cat:"Food",ctx:"Meat — from deer, turkey, and buffalo hunting — was central to the Chickasaw diet.",q:"What is the Chickasaw word for meat?",a:"Nipi (NIH-pee) means meat in Chikashshanompa'. Hunting deer, turkey, and buffalo provided meat that was central to the traditional Chickasaw diet."},
  {c:"Paska",p:"PAHS-kah",e:"Bread",cat:"Food",ctx:"Bread — including traditional frybread and corn breads like banaha.",q:"What is the Chickasaw word for bread?",a:"Paska (PAHS-kah) means bread in Chikashshanompa'. Traditional Chickasaw breads including banaha (corn shuck bread) and frybread are important cultural foods."},
  {c:"Oka sabanna",p:"OH-kah sah-BAN-nah",e:"I want some water",cat:"Food Phrases",ctx:"A basic needs phrase — requesting water.",q:"How do you say 'I want some water' in Chickasaw?",a:"Oka sabanna (OH-kah sah-BAN-nah) means 'I want some water' in Chikashshanompa'."},
  {c:"Kafi",p:"KAH-fee",e:"Coffee",cat:"Food",ctx:"Coffee — adopted into Chickasaw daily life and language.",q:"What is the Chickasaw word for coffee?",a:"Kafi (KAH-fee) means coffee in Chikashshanompa'. Coffee was adopted into Chickasaw daily life and the word reflects the language's natural absorption of new items."},

  // PEOPLE
  {c:"Minko",p:"MIN-koh",e:"Chief",cat:"People",ctx:"The chief — the traditional political and spiritual leader of the Chickasaw people. The Minko held great authority.",q:"What is the Chickasaw word for chief?",a:"Minko (MIN-koh) means chief in Chikashshanompa'. The Minko was the traditional political and spiritual leader of the Chickasaw people, a position of great authority and responsibility to the community."},
  {c:"Hattak Api Homma",p:"HAH-ttahk AH-pee HOH-mah",e:"Indian / Native American person",cat:"People",ctx:"The Chickasaw term for a Native American person — literally 'red-blooded person'.",q:"What is the Chickasaw term for Native American or Indian?",a:"Hattak Api Homma (HAH-ttahk AH-pee HOH-mah) means Native American or Indian person in Chikashshanompa' — literally 'red-blooded person'. It is the traditional term for Indigenous people."},
  {c:"Kamassa",p:"kah-MAH-sah",e:"Elder",cat:"People",ctx:"Elder — the most respected members of Chickasaw society, holders of language and cultural knowledge.",q:"What is the Chickasaw word for elder?",a:"Kamassa (kah-MAH-sah) means elder in Chikashshanompa'. Elders are the most respected members of Chickasaw society — the primary holders of language, cultural knowledge, and spiritual tradition."},
  {c:"Puskush",p:"POOS-koosh",e:"Baby",cat:"People",ctx:"Baby — the newest and most precious members of the community.",q:"What is the Chickasaw word for baby?",a:"Puskush (POOS-koosh) means baby in Chikashshanompa'. Babies are considered sacred new arrivals into the Chickasaw community."},
  {c:"Okloshi homma",p:"ohk-LOH-shee HOH-mah",e:"Indian tribes",cat:"People",ctx:"The term for Indian tribes collectively — the broader Indigenous community.",q:"What is the Chickasaw term for Indian tribes?",a:"Okloshi homma (ohk-LOH-shee HOH-mah) means Indian tribes in Chikashshanompa'. It refers to the broader community of Indigenous tribal nations."},

  // MONTHS
  {c:"Hashi Ammona",p:"HAH-shee ah-MOH-nah",e:"January",cat:"Months",ctx:"January — literally 'first sun/month' in Chickasaw.",q:"How do you say 'January' in Chickasaw?",a:"Hashi Ammona (HAH-shee ah-MOH-nah) means January in Chikashshanompa' — literally 'first sun' or 'first month'."},
  {c:"Hashi Atokla",p:"HAH-shee ah-TOHK-lah",e:"February",cat:"Months",ctx:"February — literally 'second month' in Chickasaw.",q:"How do you say 'February' in Chickasaw?",a:"Hashi Atokla (HAH-shee ah-TOHK-lah) means February in Chikashshanompa' — literally 'second month'."},
  {c:"Hashi Ayyoshta",p:"HAH-shee ah-YOHSH-tah",e:"April",cat:"Months",ctx:"April in Chickasaw.",q:"How do you say 'April' in Chickasaw?",a:"Hashi Ayyoshta (HAH-shee ah-YOHSH-tah) means April in Chikashshanompa'."},
  {c:"Hashi Apokkoli",p:"HAH-shee ah-pohk-KOH-lee",e:"October",cat:"Months",ctx:"October in Chickasaw.",q:"How do you say 'October' in Chickasaw?",a:"Hashi Apokkoli (HAH-shee ah-pohk-KOH-lee) means October in Chikashshanompa'."},
  {c:"Hashi Awa Chaffa",p:"HAH-shee AH-wah CHAHF-fah",e:"November",cat:"Months",ctx:"November in Chickasaw — literally 'eleventh month'.",q:"How do you say 'November' in Chickasaw?",a:"Hashi Awa Chaffa (HAH-shee AH-wah CHAHF-fah) means November in Chikashshanompa'."},
  {c:"Hashi Awa Toklo",p:"HAH-shee AH-wah TOHK-loh",e:"December",cat:"Months",ctx:"December in Chickasaw — literally 'twelfth month'.",q:"How do you say 'December' in Chickasaw?",a:"Hashi Awa Toklo (HAH-shee AH-wah TOHK-loh) means December in Chikashshanompa'."},

  // TIME
  {c:"Nittak",p:"NIH-ttahk",e:"Day",cat:"Time",ctx:"Day — the basic unit of time in Chickasaw.",q:"What is the Chickasaw word for day?",a:"Nittak (NIH-ttahk) means day in Chikashshanompa'. It is the foundational unit of time and appears in many compound time expressions."},
  {c:"Afammi",p:"ah-FAM-mee",e:"Year",cat:"Time",ctx:"Year — used also in the context of age.",q:"What is the Chickasaw word for year?",a:"Afammi (ah-FAM-mee) means year in Chikashshanompa'. It is also used when expressing someone's age."},
  {c:"Himmaka pila",p:"him-MAH-kah PIH-lah",e:"Future",cat:"Time",ctx:"The future — literally 'from now forward' in Chickasaw.",q:"How do you say 'future' in Chickasaw?",a:"Himmaka pila (him-MAH-kah PIH-lah) means future in Chikashshanompa' — literally 'from now forward'. It reflects the Chickasaw understanding of time as directional from the present."},
  {c:"Hopaakikaash",p:"hoh-pahk-ih-KAHSH",e:"Ancient time",cat:"Time",ctx:"Ancient time — referring to the distant past of Chickasaw history and oral tradition.",q:"How do you say 'ancient time' in Chickasaw?",a:"Hopaakikaash (hoh-pahk-ih-KAHSH) means ancient time in Chikashshanompa'. It refers to the deep historical past of the Chickasaw people — the time of oral tradition and ancestral stories."},
  {c:"Tabookoli",p:"tah-BOH-koh-lee",e:"Mid day / Noon",cat:"Time",ctx:"Midday — the middle of the day when the sun is highest.",q:"How do you say 'noon' or 'midday' in Chickasaw?",a:"Tabookoli (tah-BOH-koh-lee) means midday or noon in Chikashshanompa'."},

  // TECHNOLOGY
  {c:"Tali lopi",p:"TAH-lee LOH-pee",e:"Computer",cat:"Technology",ctx:"The Chickasaw word for computer — literally 'metal that thinks' or 'thinking metal'.",q:"What is the Chickasaw word for computer?",a:"Tali lopi (TAH-lee LOH-pee) means computer in Chikashshanompa' — literally 'thinking metal' or 'metal that knows'. It reflects how the Chickasaw language creates new words from existing roots for modern concepts."},
  {c:"Holisso palhki",p:"hoh-LIS-soh PAHL-kee",e:"Email",cat:"Technology",ctx:"Email — literally 'fast writing/letter' in Chickasaw.",q:"What is the Chickasaw word for email?",a:"Holisso palhki (hoh-LIS-soh PAHL-kee) means email in Chikashshanompa' — literally 'fast letter' or 'fast writing'. It shows how Chickasaw uses existing word roots to describe modern technology."},
  {c:"Talanompoli",p:"tah-lah-NOM-poh-lee",e:"Cell phone",cat:"Technology",ctx:"Cell phone — literally 'talking at a distance' in Chickasaw.",q:"What is the Chickasaw word for cell phone?",a:"Talanompoli (tah-lah-NOM-poh-lee) means cell phone in Chikashshanompa' — literally 'talking at a distance'. The language root nompa (speech/language) appears again in this modern word."},
  {c:"Tali lopi lawa",p:"TAH-lee LOH-pee LAH-wah",e:"Internet",cat:"Technology",ctx:"Internet — literally 'many connected thinking metals' in Chickasaw.",q:"What is the Chickasaw word for internet?",a:"Tali lopi lawa (TAH-lee LOH-pee LAH-wah) means internet in Chikashshanompa' — literally 'many computers connected'. The language beautifully describes the internet using existing roots."},
  {c:"Holba aapisa",p:"HOHL-bah ah-PIH-sah",e:"Television",cat:"Technology",ctx:"Television — literally 'moving image to watch' in Chickasaw.",q:"What is the Chickasaw word for television?",a:"Holba aapisa (HOHL-bah ah-PIH-sah) means television in Chikashshanompa' — literally 'image to watch' or 'moving picture'. Holba means image or likeness."},
  {c:"Ishtholbachi",p:"ish-tohl-BAH-chee",e:"Camera",cat:"Technology",ctx:"Camera — literally 'that which makes images' in Chickasaw.",q:"What is the Chickasaw word for camera?",a:"Ishtholbachi (ish-tohl-BAH-chee) means camera in Chikashshanompa' — literally 'that which creates images or likenesses'."},

  // CAREERS
  {c:"Alikchi",p:"ah-LIK-chee",e:"Doctor / Healer",cat:"Careers",ctx:"Doctor or healer — rooted in the traditional medicine person role. Now also used for modern medical doctors.",q:"What is the Chickasaw word for doctor?",a:"Alikchi (ah-LIK-chee) means doctor or healer in Chikashshanompa'. The word is rooted in the traditional medicine person who used plant medicine and ceremony for healing. It now also refers to modern medical doctors."},
  {c:"Holisso Pisachi",p:"hoh-LIS-soh pih-SAH-chee",e:"Teacher",cat:"Careers",ctx:"Teacher — literally 'one who shows the writing/knowledge'. Education was highly valued by the Chickasaw Nation.",q:"What is the Chickasaw word for teacher?",a:"Holisso Pisachi (hoh-LIS-soh pih-SAH-chee) means teacher in Chikashshanompa' — literally 'one who shows the book' or 'one who shows knowledge'. The Chickasaw Nation established schools before Oklahoma statehood, showing their deep value for education."},
  {c:"Naa-alhtoka",p:"nah-AHL-toh-kah",e:"Police officer",cat:"Careers",ctx:"Police officer in modern Chickasaw usage.",q:"What is the Chickasaw word for police officer?",a:"Naa-alhtoka (nah-AHL-toh-kah) means police officer in Chikashshanompa'. The Chickasaw Nation has its own Lighthorse Police force, continuing a tradition of sovereign law enforcement."},
  {c:"Tashka-chipota",p:"TAHSH-kah chih-POH-tah",e:"Soldier / Warrior",cat:"Careers",ctx:"Soldier or warrior — the Chickasaw were renowned as fierce warriors, earning the name 'Unconquered and Unconquerable'.",q:"What is the Chickasaw word for warrior or soldier?",a:"Tashka-chipota (TAHSH-kah chih-POH-tah) means soldier or warrior in Chikashshanompa'. The Chickasaw were renowned as fierce warriors — they were called 'Unconquered and Unconquerable' by neighboring peoples and European colonizers alike."},

  // MATERIALS & CULTURAL ITEMS
  {c:"Sholosh",p:"SHOH-losh",e:"Shoes / Moccasins",cat:"Materials",ctx:"Shoes or moccasins — traditional Chickasaw footwear made from deerskin.",q:"What is the Chickasaw word for shoes or moccasins?",a:"Sholosh (SHOH-losh) means shoes or moccasins in Chikashshanompa'. Traditional moccasins were made from deerskin and were a central element of Chickasaw dress."},
  {c:"Naafokha",p:"nah-FOH-kah",e:"Clothes",cat:"Materials",ctx:"Clothes or clothing — the general term for garments.",q:"What is the Chickasaw word for clothes?",a:"Naafokha (nah-FOH-kah) means clothes or clothing in Chikashshanompa'."},
  {c:"Osi hishi",p:"OH-see HIH-shee",e:"Eagle feathers",cat:"Materials",ctx:"Eagle feathers — sacred items used in ceremony and traditional regalia. Eagle feathers carry deep spiritual significance.",q:"What is the Chickasaw word for eagle feathers?",a:"Osi hishi (OH-see HIH-shee) means eagle feathers in Chikashshanompa'. Eagle feathers are sacred items used in ceremony and traditional regalia — they carry deep spiritual significance and are treated with great reverence."},
  {c:"Oksop",p:"OHK-sop",e:"Beads",cat:"Materials",ctx:"Beads — used in traditional Chickasaw regalia, jewelry, and ceremonial items.",q:"What is the Chickasaw word for beads?",a:"Oksop (OHK-sop) means beads in Chikashshanompa'. Beadwork is an important Chickasaw art form used in traditional regalia, jewelry, and ceremonial items."},
  {c:"Issi hakshop",p:"IH-see HAHK-shop",e:"Buckskin",cat:"Materials",ctx:"Buckskin — deerskin leather, the primary material for traditional Chickasaw clothing and moccasins.",q:"What is the Chickasaw word for buckskin?",a:"Issi hakshop (IH-see HAHK-shop) means buckskin or deerskin in Chikashshanompa'. Buckskin was the primary material for traditional Chickasaw clothing, moccasins, and bags."},

  // STOMP DANCE
  {c:"Lowak",p:"LOH-wahk",e:"Fire",cat:"Stomp Dance",ctx:"Fire — sacred and central to the stomp dance ceremony. The sacred fire is the heart of the stomp ground.",q:"What is the Chickasaw word for fire?",a:"Lowak (LOH-wahk) means fire in Chikashshanompa'. Fire is sacred and central to the stomp dance ceremony — the sacred fire at the stomp ground is the spiritual heart of the gathering."},
  {c:"Hilha",p:"HIL-hah",e:"Dance",cat:"Stomp Dance",ctx:"Dance — central to Chickasaw spiritual and community life through the stomp dance tradition.",q:"What is the Chickasaw word for dance?",a:"Hilha (HIL-hah) means dance in Chikashshanompa'. Dancing is central to Chickasaw spiritual and community life — the stomp dance tradition has been maintained continuously despite removal and cultural suppression."},
  {c:"Loksi shaali",p:"LOHK-see SHAH-lee",e:"Shell shaker",cat:"Stomp Dance",ctx:"The shell shaker — women who wear turtle shell rattles tied to their legs and lead the rhythm of the stomp dance. This is a position of great honor.",q:"What is a shell shaker in Chickasaw?",a:"Loksi shaali (LOHK-see SHAH-lee) means shell shaker in Chikashshanompa'. Shell shakers are women who wear turtle shell rattles tied to their legs and provide the rhythm for the stomp dance. Being a lead shell shaker is a position of great honor in Chickasaw ceremonial life."},
  {c:"Nittak ishtayyopi ona'chi Chikashsha alhihaat hoottibaahilhachinka",p:"NIH-ttahk ish-TAY-yoh-pee OH-nah-chee",e:"The Chickasaw people will dance until the world ends",cat:"Stomp Dance",ctx:"A sacred declaration of cultural continuity — the Chickasaw people will maintain their traditions forever.",q:"What is the sacred declaration about Chickasaw dancing?",a:"'Nittak ishtayyopi ona'chi Chikashsha alhihaat hoottibaahilhachinka' means 'The Chickasaw people will dance until the world ends' in Chikashshanompa'. This phrase is a powerful declaration of cultural continuity — no matter what hardships the Nation has faced, the stomp dance continues."},

  // EMOTIONAL STATES
  {c:"Asayoppa",p:"ah-sah-YOHP-pah",e:"I am happy",cat:"Emotions",ctx:"The expression of happiness in Chickasaw.",q:"How do you say 'I am happy' in Chickasaw?",a:"Asayoppa (ah-sah-YOHP-pah) means 'I am happy' in Chikashshanompa'."},
  {c:"Sashaa",p:"sah-SHAH",e:"I am angry",cat:"Emotions",ctx:"The expression of anger in Chickasaw.",q:"How do you say 'I am angry' in Chickasaw?",a:"Sashaa (sah-SHAH) means 'I am angry' in Chikashshanompa'."},
  {c:"Samihlha",p:"sah-MIH-lhah",e:"I am scared",cat:"Emotions",ctx:"The expression of fear in Chickasaw.",q:"How do you say 'I am scared' in Chickasaw?",a:"Samihlha (sah-MIH-lhah) means 'I am scared' in Chikashshanompa'."},
  {c:"Sanokshila",p:"sah-nohk-SHIH-lah",e:"I am thirsty",cat:"Emotions",ctx:"The expression of thirst in Chickasaw.",q:"How do you say 'I am thirsty' in Chickasaw?",a:"Sanokshila (sah-nohk-SHIH-lah) means 'I am thirsty' in Chikashshanompa'."},
  {c:"Appossi iholloli",p:"ah-POH-see ih-HOH-loh-lee",e:"I love my grandmother",cat:"Emotions",ctx:"Expressing love for one's grandmother — a deeply meaningful phrase in the matrilineal Chickasaw culture.",q:"How do you say 'I love my grandmother' in Chickasaw?",a:"Appossi iholloli (ah-POH-see ih-HOH-loh-lee) means 'I love my grandmother' in Chikashshanompa'. In the matrilineal Chickasaw culture, grandmothers hold a position of special reverence and love."},

  // NATURE EXTENDED
  {c:"Oklhili",p:"ohk-LHIH-lee",e:"Dark / Night",cat:"Nature",ctx:"Darkness or night — used in weather descriptions and time of day.",q:"How do you say 'dark' or 'night' in Chickasaw?",a:"Oklhili (ohk-LHIH-lee) means dark or night in Chikashshanompa'. It appears in compound words like Oklhili Hashi (moon — literally 'night sun')."},
  {c:"Kapassa",p:"kah-PAH-sah",e:"Cold",cat:"Weather",ctx:"Cold — used in weather descriptions.",q:"How do you say 'cold' in Chickasaw?",a:"Kapassa (kah-PAH-sah) means cold in Chikashshanompa'. It is used in weather phrases like 'himmaka nittakat kapassa' — 'it is a cold day.'"},
  {c:"Lashpa",p:"LAHSH-pah",e:"Warm",cat:"Weather",ctx:"Warm — used in weather descriptions.",q:"How do you say 'warm' in Chickasaw?",a:"Lashpa (LAHSH-pah) means warm in Chikashshanompa'. It is used in weather phrases like 'himmaka nittakat lashpa' — 'it is a warm day.'"},
  {c:"Hoshonti",p:"hoh-SHOHN-tee",e:"It is cloudy",cat:"Weather",ctx:"A weather phrase for cloudy conditions.",q:"How do you say 'it is cloudy' in Chickasaw?",a:"Hoshonti (hoh-SHOHN-tee) means 'it is cloudy' in Chikashshanompa'."},
  {c:"Omba'chi",p:"ohm-BAH-chee",e:"It's going to rain",cat:"Weather",ctx:"A weather prediction phrase — it is going to rain.",q:"How do you say 'it's going to rain' in Chickasaw?",a:"Omba'chi (ohm-BAH-chee) means 'it's going to rain' in Chikashshanompa'."},
];
